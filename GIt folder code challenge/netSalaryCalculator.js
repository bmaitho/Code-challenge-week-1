...
const calculatePayee = (monthlySalary) => {
    if (monthlySalary <= 24000) {
       ...
       return monthlySalary * 0.35;
        // 35% tax rate for income > 800,000
    }
    };
  ...
  const calculateNhifDeduction = (grossPay) => {
    if (grossPay <= 5999) {
      ...
      return Math.min(grossPay * 0.05, 1700); 
    }
  };
