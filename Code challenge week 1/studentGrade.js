...
//This is a program that prompts the user to input student marks within a range of zero to a hundred and gives a grade as per the scale provided const{Console} = require("console");
...
function studentGrade(userInput){
    while(userInput<0 || userInput>100){
      userInput = rl.question("Invalid input(Between 0 and 100):",)
   }
...
return finalGrade;
        ...
        //This shows output of user input and correct grade
rl.question("Enter student marks (Between 0 and 100):",(userInput)=>{
    const finalGrade = studentGrade(parseInt(userInput));
  console.log(`The student's grade is: ${finalGrade}`);
  rl.close();
});
